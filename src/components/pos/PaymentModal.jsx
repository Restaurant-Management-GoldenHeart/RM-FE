      ...
      <div className="relative bg-white w-full lg:max-w-5xl h-[90vh] lg:h-[720px] rounded-t-[2.5rem] lg:rounded-[2.5rem] shadow-2xl flex flex-col lg:flex-row overflow-hidden animate-in slide-in-from-bottom-8 mt-auto lg:mt-0">
        ...
        >
          ...
          <div className="hidden lg:flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 className="font-black text-gray-900 uppercase text-lg">Hóa đơn</h3>
        ...
        >
          <div className="flex justify-between items-start px-6 pt-5 pb-2 shrink-0">
            <div>
              ...
              <p className="text-gray-400 text-[10px] font-medium">Chọn phương thức và ưu đãi.</p>
            </div>
          ...
          <div className="flex-1 overflow-y-auto px-6 pb-2 no-scrollbar">
            <div className="space-y-4 mb-4">
              ...
              <div className="space-y-3">
                <label className="text-[9px] font-black text-gray-400 uppercase block ml-1">Ưu đãi và thuế</label>
                  ...
                  <div className="flex items-center gap-3 text-left">
                    <div
                      className={cn(
                        ...
                        applyLoyalty ? 'bg-emerald-600 text-white' : 'bg-gray-50 text-gray-400'
                      )}
                    >
                      <Gift size={14} />
                    </div>
                    <div>
                      ...
                      <p className={cn('text-[7px] font-bold uppercase', applyLoyalty ? 'text-emerald-600' : 'text-gray-300')}>
                        Dùng ưu đãi tích điểm
                      </p>
                    </div>
                  </div>
                  <div

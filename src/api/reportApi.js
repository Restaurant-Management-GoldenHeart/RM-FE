...
export const reportApi = {
  ...
  getRevenueTimeseries: (branchId, fromDate, toDate, groupBy = 'DAY') => {
    ...
    if (branchId && !isNaN(branchId)) params.branchId = Number(branchId);
    return apiClient.get('/reports/revenue/timeseries', { params });
  },
  ...
  /**
   * 6. Get Bill History (Paginated)
   * GET /bills/history?branchId=&status=&fromDate=&toDate=&keyword=&page=&size=
   */
  getBillHistory: (params) =>
    apiClient.get('/bills/history', { params }),
